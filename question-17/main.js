...
console.log(`Sorry Mr. ${removeGuest2}.you  are not  invited to dinner.`);
let removeGuest3 = guestList.pop();
console.log(`Sorry Mr. ${removeGuest3}.you  are not  invited to dinner.`);
let removeGuest4 = guestList.pop();
console.log(`Sorry Mr. ${removeGuest4}.you  are not  invited to dinner.`);
